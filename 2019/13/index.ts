...
export default class Puzzle extends AoCPuzzle {
      ...
      for (let x = this.minX - 1; x <= this.maxX; x += 1) {
        ...
        if (this.tiles.has(key)) {
          switch (this.tiles.get(key)) {
            case 1: pixel = '█'; break;
            case 2: pixel = '\x1b[34m█\x1b[0m'; break;
            case 3: pixel = '▀'; break;
            case 4: pixel = '\x1b[31mO\x1b[0m'; break;
          }
        }
        row.push(pixel);
      }
  ...
  public async part2(): Promise<string | number> {
    ...
    this.minX = Number.MAX_SAFE_INTEGER; this.maxX = Number.MIN_SAFE_INTEGER;
    this.minY = Number.MAX_SAFE_INTEGER; this.maxY = Number.MIN_SAFE_INTEGER;
