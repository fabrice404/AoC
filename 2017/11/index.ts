...
export default class Puzzle extends AoCPuzzle {
  ...
  public async part1(): Promise<string | number> {
    ...
    for (const dir of input) {
      switch (dir) {
        case 'n': this.targetY -= 2; break;
        case 's': this.targetY += 2; break;
        case 'ne': this.targetX += 1; this.targetY -= 1; break;
        case 'nw': this.targetX -= 1; this.targetY -= 1; break;
        case 'se': this.targetX += 1; this.targetY += 1; break;
        case 'sw': this.targetX -= 1; this.targetY += 1; break;
